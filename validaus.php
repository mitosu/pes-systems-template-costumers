...
<br>Basamos la calidad de nuestros servicios en garantizar rapidez y seriedad en los mismos, logrando la máxima efectividad con un seguimiento exhaustivo en los trabajos realizados.

Nuestra profesionalidad nos aporta un amplio conocimiento del sector, pudiendo responder ante cualquier situación planteada y disponiendo de una variada gama de productos a precios competitivos.

<br><br style="line-height:11px"><img src="images/1_z1.gif" style="margin-right:5px" alt="" border="0"><b><a href="#">Mas información</a></b></div></td>
															</tr>
															<tr>
...
PRINT("<li><a href='buscafac.php?xcodigo=".$xpescodigo."&xempresa=".$xempresa."'><b>Facturación</b></font></a></li>");
...
<strong><a href="mailto:<?include "empemail.php";?>?subject=Petición de claves web empresa:"><strong>Contacte con nosotros</strong></a></strong><br>
 Pinche aqui si quiere ponerse en contacto con nosotros por e-mail <a href="mailto:<?include "empemail.php";?>"><strong><?include "empemail.php";?></strong></a><br>Para contactar por telefono Tel: &nbsp;<?include "emptel.php";?> nuestro horario de oficina es de 09h00 a 19h00 lunes a viernes. Fax <?include "empfax.php";?><br>
<!---
...
<br>
<strong><a href="mailto:?subject=Recomiendo esta web <?include "empweb.php";?>"><strong>Recomiendenos</strong></a></strong><br>
Envie un link a este sitio a otra persona<br>
 pinchando <a href="mailto:?subject=Recomiendo esta web <?include "empweb.php";?>"><strong>aqui</strong></a><br><br style="line-height:9px">
